...
import { Box, Bird, Cat, Rabbit, Users, Code2, Wand2, Hammer, FolderOpen, ChevronUp, FileJson, History, Play, Pause, Info, Wrench, Loader2, Castle } from 'lucide-react';
...
interface UIOverlayProps {
  ...
  onNewScene: (type: 'Eagle' | 'Castle') => void;
      ...
      <div className="absolute top-4 left-4 right-4 flex justify-between items-start">
        ...
        <div className="pointer-events-auto flex flex-col gap-2">
            ...
            >
                ...
                <DropdownItem onClick={() => onNewScene('Castle')} icon={<Castle size={16}/>} label="Giant Castle" />
